...
var LinkExternal = function (_a) {
    ...
    return (React.createElement(Link, __assign({ external: true,color:"primary" }, props),
        children,
...
var socials = [
    {
        label: "Github",
        icon: "GithubIcon",
        href: "https://github.com/PantheonFinance/",
    },
    {
        label: "Docs",
        icon: "DocIcon",
        href: "https://app.gitbook.com/@pantheonfinance/s/pantheon-finance/",
    },
    {
        label: "Medium",
        icon: "MediumIcon",
...
var Accordion = function (_a) {
    ...
    return (React.createElement(Container$2, { onMouseOver: showSubmenu, onMouseOut: closeSubmenu },
        React.createElement(MenuEntry, { className: className, onMouseOver: showSubmenu },
            icon,
            React.createElement(LinkLabel, { isPushed: isPushed, onMouseOver: showSubmenu }, label),
            isOpen ? React.createElement(Icon$8,  { onMouseOver: showSubmenu } ) : React.createElement(Icon$7, null)),
...
var PanelFooter = function (_a) {
    ...
    return (React.createElement(Container$4, null,
      cakePriceUsd ? (React.createElement(PriceLink, { href: priceLink, target: "_blank" },
        ...
        React.createElement(Text, { color: "primary", bold: true, fontSize: "16px" }, "$" + cakePriceUsd.toFixed(3)))) : (React.createElement(Skeleton, { width: 80, height: 24 })),
...
var AccountModal = function (_a) {
    ...
    return (React.createElement(Modal, { title: "Your wallet", onDismiss: onDismiss },
        React.createElement(Text, { color: "primary", fontSize: "20px", bold: true, style: { whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis", marginBottom: "8px" } }, account),
        React.createElement(Flex, { mb: "32px" },
            React.createElement(LinkExternal, { color: "primary", small: true, href: "https://bscscan.com/address/" + account, mr: "16px" }, "View on BscScan"),
            React.createElement(CopyToClipboard, { toCopy: account }, React.createElement(Text, { bold: true, color: "primary" },"Copy Address"))),
...
var lightColors = __assign(__assign(__assign({}, baseColors), brandColors), { background: "#f7fafc", backgroundDisabled: "#3c3742", contrast: "#FFFFFF", invertedContrast: "#191326", input: "#483f5a", tertiary: "#c9d3de", text: "#fff", textDisabled: "#666171", textSubtle: "#c9c4d4", borderColor: "#524B63", card: "linear-gradient(to bottom, #fff, #cbd5e0)", gradients: {
        bubblegum: "linear-gradient(139.73deg, #E6FDFF 0%, #F3EFFF 100%)",
    } });
var darkColors = __assign(__assign(__assign({}, baseColors), brandColors), { secondary: "#8c9ecd", background: "#f7fafc", backgroundDisabled: "#3c3742", contrast: "#FFFFFF", invertedContrast: "#191326", input: "#483f5a", primaryDark: "#0098A1", tertiary: "#531418", text: "#c9d3de", textDisabled: "#666171", textSubtle: "#c9c4d4", borderColor: "#524B63", card: "linear-gradient(to bottom, #fff, #cbd5e0)", gradients: {
